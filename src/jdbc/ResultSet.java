...
public class ResultSet implements java.sql.ResultSet {
	...
	private void checkResultSet(int column) throws SQLException {
		...
		if (!IndexToColumnType.containsKey(column-1)) {// 4
...
//converting methods///////////////////////////////////////////////////////////////////	
//////////////////////////////////////////////////////////////////////////////////////
	public int columnsNumber(ResultSet rs){
		return (rs.getColumnNameToIndex().size());
	}
	...
	private double toDouble(String s) throws SQLException{
        if (s != null){
            try{
            	...
            	log.error("Wrong value for type double");
	...
	public Array toArray(String s,int columnIndex) throws SQLException{
		...
		Array array = new jdbc.Array(elements, IndexToColumnType.get(columnIndex-1));
	...
	private Object toObject(int columnIndex) throws SQLException{
		switch(getTypeNumber(IndexToColumnType.get(columnIndex-1))){
	...
	public int findColumn(String columnLabel) throws SQLException {
		...
		if (!getColumnNameToIndex().containsKey(columnLabel)){
		...
		int result = getColumnNameToIndex().get(columnLabel) + 1;	
	...
	public boolean getBoolean(int columnIndex) throws SQLException {
		...
		if (!IndexToColumnType.get(columnIndex-1).equalsIgnoreCase("Boolean")){
	...
	public Date getDate(int columnIndex) throws SQLException {
		...
		if (!IndexToColumnType.get(columnIndex-1).equalsIgnoreCase("Date")){
			log.error("This column has a different type.");
			throw new SQLException("This column has a different type.");
		}
	...
	public double getDouble(int columnIndex) throws SQLException {
		...
		if (!IndexToColumnType.get(columnIndex-1).equalsIgnoreCase("double")){
			log.error("This column has a different type.");
			throw new SQLException("This column has a different type.");}
	...
	public float getFloat(int columnIndex) throws SQLException {
		...
		if (!IndexToColumnType.get(columnIndex-1).equalsIgnoreCase("float")){
			log.error("This column has a different type.");
			throw new SQLException("This column has a different type.");}
	...
	public int getInt(int columnIndex) throws SQLException {
		...
		if (!IndexToColumnType.get(columnIndex-1).equalsIgnoreCase("int"))
			throw new SQLException("This column has a different type.");
	...
	public long getLong(int columnIndex) throws SQLException {
		...
		if (!IndexToColumnType.get(columnIndex-1).equalsIgnoreCase("long")){
			log.error("This column has a different type.");
			throw new SQLException("This column has a different type.");}
	...
	public ResultSetMetaData getMetaData() throws SQLException {
        ...
        if (metaData == null) {
        	metaData = new jdbc.ResultSetMetaData(columnNameToIndex, IndexToColumnType, getProp());
        }
		testResult = "done";
        return metaData;
	}
	...
	public String getString(int columnIndex) throws SQLException {
		...
		if (!IndexToColumnType.get(columnIndex-1).equalsIgnoreCase("String")){
			log.error("This column has a different type.");
			throw new SQLException("This column has a different type.");}
	...
	public void setColumnNameToIndex(HashMap<String, Integer> columnNameToIndex) {
		this.columnNameToIndex = columnNameToIndex;
	}
